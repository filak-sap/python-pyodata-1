...
class EntityProxy:
            ...
            for prop in self._entity_type.nav_proprties:
                ...
                if prop.name in proprties:
                    ...
                    if prop.to_role.multiplicity in \
                            [v2_elements.EndRole.MULTIPLICITY_ONE,
                             v2_elements.EndRole.MULTIPLICITY_ZERO_OR_ONE]:
                    ...
                    elif prop.to_role.multiplicity == v2_elements.EndRole.MULTIPLICITY_ZERO_OR_MORE:
    ...
    def nav(self, nav_property):
        ...
        if all((role.multiplicity != v2_elements.EndRole.MULTIPLICITY_ZERO_OR_MORE for role in roles)):
